...
📈 FinPulse: India Financial Performance & Regional Intelligence Dashboard  
...
The FinPulse Dashboard is a visually engaging and analytical Power BI report designed to help executives, financial analysts, and regional leaders explore and monitor enterprise-wide financial performance across India from FY22 to FY26. The dashboard highlights core financial metrics including total revenue (**362.25bn**), profit margins (**14.59%**), sales volume (**1.45bn liters**), and state-level YoY performance, empowering data-driven strategic planning and forecasting.
...
- **Geographic Sales & Category Heatmap (Bottom Left):** A geographic choropleth map of India segmented by East, North, South, and West zones alongside a hierarchical treemap displaying revenue and volume distributions across product categories[cite: 1].  
- **Technical Matrix & YoY Analysis (Bottom Right):** A detailed tabular matrix breaking down Total Revenue, Profit Margin %, and Total Volume (Litres) per state alongside grand totals, paired with a Revenue Change Drivers waterfall chart explaining variances from Starting to Ending Revenue[cite: 1].
